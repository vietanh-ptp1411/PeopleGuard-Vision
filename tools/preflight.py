...
def main() -> int:
    ...
    if args.json:
        ...
        print("=" * (width + 40))
        print("VisionGuard - kiem tra truoc khi chay")
        print("=" * (width + 40))
        ...
        print("-" * (width + 40))
        if r.failed:
            print("KHONG THE CHAY: sua cac muc [FAIL] o tren roi thu lai.")
        elif r.warned:
            print("CHAY DUOC, nhung co canh bao [WARN] o tren.")
        else:
            print("SAN SANG: moi thu deu dat.")
